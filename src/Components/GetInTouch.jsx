...
const GetInTouch = () => {
  return (
    <div className="px-4 py-8 md:px-10 md:py-10 lg:px-[120px] lg:py-120px mb-10">
      <div className="bg-[#0058FF] p-4 md:p-10 lg:p-20 rounded-3xl">
        ...
        <div className="flex justify-center">
          <button className="text-[#0058FF] cursor-pointer text-sm md:text-base font-bold md:py-4 py-[10px] px-5 md:px-6 bg-white rounded-lg flex items-center">
